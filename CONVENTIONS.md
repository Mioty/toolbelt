...
Is recommended to be one of the below items. Only **feat**, **fix**, and **perf** cause a version bump (and deploy) and show up in the changelog, in addition to breaking changes (see breaking changes section at bottom).
...
*will cause a new version to be deployed automatically
